        ...
        RoleManager<IdentityRole> roleManager) : IDbInitializer
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            if (!_context.DeliveryMethods.Any())
            {
                ...
                // \Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\brands.json
                var deliveryData = await File.ReadAllTextAsync(@"..\Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\delivery.json");
            ...
            if (!_context.ProductBrands.Any())
            {
                ...
                // 1. Real All Data From Json File (brands.json)
                // \Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\brands.json
                var brandsdata = await File.ReadAllTextAsync(@"..\Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\brands.json");
            ...
            if (!_context.ProductTypes.Any())
            {
                ...
                // 1. Real All Data From Json File (brands.json)
                // \Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\brands.json
                var typesdata = await File.ReadAllTextAsync(@"..\Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\types.json");
            ...
            if (!_context.Products.Any())
            {
                ...
                // 1. Real All Data From Json File (brands.json)
                // \Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\brands.json
                var productsData = await File.ReadAllTextAsync(@"..\Infrastructure\Store.G04.Khaled.persistence\Data\DataSeeding\products.json");
